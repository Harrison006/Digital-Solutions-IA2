...
class MainWindow:
    ...
    def signals(self):
        ...
        """
        self.ui.pushButton.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.login_as_clinician))
        self.ui.pushButton_2.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.log_in_as_practice_administrator))
        self.ui.lg_login_btn_2.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.log_in_page))
        self.ui.lg_login_btn_4.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.log_in_page))
        self.ui.pushButton_3.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.patientdetails))
        self.ui.pushButton_9.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.clinician_home_page))
        self.ui.pushButton_10.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.clinician_home_page))
        self.ui.pushButton_18.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.clinician_home_page))
        self.ui.pushButton_24.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.clinician_home_page))
        self.ui.pushButton_20.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.clinician_home_page))
        self.ui.pushButton_23.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.clinician_home_page))
        self.ui.pushButton_29.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.clinician_home_page))
        self.ui.pushButton_26.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.clinician_home_page))
        self.ui.pushButton_28.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.clinician_home_page))
        self.ui.pushButton_27.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.clinician_home_page))
        self.ui.pushButton_59.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.log_in_page))
        self.ui.pushButton_62.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.practice_admin_menu))
        self.ui.pushButton_64.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.practice_admin_menu))
        self.ui.pushButton_5.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.typeofassessment))
        self.ui.pushButton_15.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.page))
        self.ui.pushButton_16.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.record_OT_assessent))
        self.ui.pushButton_17.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.Physio_appointment_results))
        self.ui.pushButton_14.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.appointment_details))
        self.ui.pushButton_7.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.previous_appointments))
        self.ui.pushButton_6.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.record_regime))
        self.ui.pushButton_25.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.previous_exercise_regime))
        self.ui.pushButton_60.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.insertclinician))
        self.ui.pushButton_61.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.page_3))
        self.ui.pushButton_sign_out.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.log_in_page))
        self.ui.pushButton_get_patient_id.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.get_patient_id))
        self.ui.pushButton_view_exercises.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.exercise_viewer))
        self.ui.pushButton_65.clicked.connect(lambda: self.ui.stackedWidget.setCurrentWidget(self.ui.clinician_home_page))
        ...
        self.ui.physio_patient_id_lbl_2.textChanged.connect(self.show_appointment_dates_1)
        self.ui.physio_patient_id_lbl.textChanged.connect(self.show_appointment_dates_2)
        self.ui.physio_patient_id_lbl_3.textChanged.connect(self.show_appointment_dates_3)
        self.ui.previous_appointments_patient_id.textChanged.connect(self.show_previous_appointments)
    ...
    def submit_patient_info(self):
        ...
        self.db.add_patient_detials(first_name,last_name,suburb,address,phone_number,email,gender)
        self.ui.stackedWidget.setCurrentWidget(self.ui.clinician_home_page)
    ...
    def book_appointment(self):
        ...
        self.db.add_appointment_details(first_name,last_name,clinician,full_date,full_time)
        self.ui.stackedWidget.setCurrentWidget(self.ui.clinician_home_page)
    ...
    def insert_physio_results(self):
        ...
        self.db.add_physio_results(patient_id,appointment_date,Hip_flexor_score,Knee_externsors_score,Dorsiflexors_score,Plantar_flexors_score)
    def insert_speech_results(self):
        ...
        self.db.add_speech_results(patient_id,appointment_date,aphasia_score,apraxia_score,dysarthria_score,dysphonia_score,memory_score,attention_score,judgment_score,neglect_score)
    ...
    def show_appointment_dates_1(self):
        ...
        try:
            ...
            self.ui.physio_appointment_date_lbl_2.setText(appointment_date[actual_amount-1])
            appointment_time = self.db.get_appointments_time(patient_id)
            self.ui.physio_appointment_time_lbl_2.setText(appointment_time[actual_amount-1])
    ...
    def show_appointment_dates_2(self):
        ...
        try:
            ...
            self.ui.physio_appointment_date_lbl.setText(appointment_date[actual_amount-1])
            appointment_time = self.db.get_appointments_time(patient_id)
            self.ui.physio_appointment_time_lbl.setText(appointment_time[actual_amount-1])
    ...
    def show_appointment_dates_3(self):
        ...
        try:
            ...
            self.ui.physio_appointment_date_lbl_3.setText(appointment_date[actual_amount-1])
            appointment_time = self.db.get_appointments_time(patient_id)
            self.ui.physio_appointment_time_lbl_3.setText(appointment_time[actual_amount-1])
